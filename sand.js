...
var ASM_CONSTS = {
 ...
 89134: () => { return document.getElementById('canvas').width; },  
 89186: () => { return parseInt(document.getElementById('canvas').style.width); },  
 89254: () => { document.exitFullscreen(); },  
 89281: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 89354: () => { if (document.fullscreenElement) return 1; },  
 89400: () => { return document.getElementById('canvas').width; },  
 89452: () => { return screen.width; },  
 89477: () => { document.exitFullscreen(); },  
 89504: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 89637: () => { if (document.fullscreenElement) return 1; },  
 89683: () => { return document.getElementById('canvas').width; },  
 89735: () => { return parseInt(document.getElementById('canvas').style.width); },  
 89803: () => { if (document.fullscreenElement) return 1; },  
 89849: () => { return document.getElementById('canvas').width; },  
 89901: () => { return screen.width; },  
 89926: () => { if (document.fullscreenElement) return 1; },  
 89972: () => { return document.getElementById('canvas').width; },  
 90024: () => { return screen.width; },  
 90049: () => { document.exitFullscreen(); },  
 90076: () => { if (document.fullscreenElement) return 1; },  
 90122: () => { return document.getElementById('canvas').width; },  
 90174: () => { return parseInt(document.getElementById('canvas').style.width); },  
 90242: () => { document.exitFullscreen(); },  
 90269: () => { return screen.width; },  
 90294: () => { return screen.height; },  
 90320: () => { return window.screenX; },  
 90347: () => { return window.screenY; },  
 90374: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 90427: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 90498: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 90555: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 90626: () => { if (document.fullscreenElement) return 1; },  
 90672: () => { if (document.pointerLockElement) return 1; }
};
